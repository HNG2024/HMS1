  ...
  return (
    <View style={styles.container}>
      <View style={styles.navbar}>
        ...
        <Text style={styles.navTitle}>HNG Product Service</Text>
        <TouchableOpacity style={styles.navButton} onPress={() => navigation.navigate('AddProduct', { addProduct: handleAddProduct })}>
